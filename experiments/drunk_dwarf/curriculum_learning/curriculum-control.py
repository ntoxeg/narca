...
NUM_EPISODES = 100  # the number of alotted episodes is the sum of all curriculum agent's episode counts
MAX_ITERATIONS = 100
ENV_NAME = "GDY-Drunk-Dwarf-v0"
MAIN_TAG = "curriculum-control"
DIFFICULTY_LEVEL = 2
...
if __name__ == "__main__":
    ...
    # this is the control group so we don't load any concepts
